    ...
    with ZipFile(input_file, 'r') as archive:
        ...
        for rel_path in worksheet_rels:
            ...
            for rel in rels_tree.findall(".//{http://schemas.openxmlformats.org/package/2006/relationships}Relationship"):
                if "drawing" in rel.attrib["Type"]:
                    ...
                    drawing_to_sheet[drawing_file] = display_sheet_name
        ...
        for drawing_path in drawing_files:
            ...
            try:
                ...
                sheet_name = drawing_to_sheet.get(drawing_path, f"Unknown_Sheet_{drawing_path}")
                print(sheet_name)

                drawing_rels_path = drawing_path.replace("xl/drawings/", "xl/drawings/_rels/") + ".rels"
                print(drawing_rels_path)
...
def convert_xlsx_to_markdown_with_images(input_file, output_file, image_output_dir): 
    """ 
    ...
    try: # Extract images 
        ...
        with open(output_file, 'w', encoding='utf-8') as md_file: 
            for sheet_name in excel_data.sheet_names: # Write the sheet name 
                md_file.write(f"# {sheet_name}\n\n") # Convert the sheet's data to Markdown 
...
# Example usage 
input_file = "C:/Users/ohuweih/Downloads/7_2_CUS_AFB_RMC_RMB_QUALIFYING_ACTIVITIES_HELP_TEXT_v43.01.xlsx" 
output_file = "cus_afb_rms.md" 
image_output_dir = "extracted_images/" 

convert_xlsx_to_markdown_with_images(input_file, output_file, image_output_dir)